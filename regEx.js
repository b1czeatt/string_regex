...
console.log("Numbers with 2 or 3 digits:", numberLength2Or3(text));
console.log("Numbers starting with an even digit:", startsWithEven(text));
console.log("Words starting with a number:", startsWithNumber(text));
console.log("Capitalized words:", capitalized(text));
console.log("Capitalized words with at least 3 letters:", capitalizedLengthMin3(text));
console.log("Words starting with a vowel:", startsWithVowel(text));
